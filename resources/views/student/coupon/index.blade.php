                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="coupon_id" id="coupon_date">
                                                ...
                                                @foreach ($coupons as $coupon )
                                                    <option value="{{ $coupon->id }}">Date : {{ $coupon->coupon_date->format('d-M-Y') }} - {{ $coupon->type === "L" ? "Lunch" : "Dinner" }} - {{ $coupon->unit_price }} BDT - {{ $coupon->max_count - $coupon->sold_coupon }} Units</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
